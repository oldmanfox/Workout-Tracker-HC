...
@interface Tone_Endurance_1_TVC ()

@end

@implementation Tone_Endurance_1_TVC
...
- (void)loadArrays {
    ...
    self.Titles = @[@"Bench Run Ups - L",
                    @"Bench Run Ups - R",
                    @"Negative Pull-Ups",
                    @"Step-Up Cross Over - R",
                    @"Step-Up Cross Over - L",
                    @"Decline Push-Up",
                    @"1-Hand Row Leg Ext - R",
                    @"1-Hand Row Leg Ext - L",
                    @"Incline Press",
                    @"Plank Hold Knee Drop"];
