...
@interface Bulk_Power_1_TVC ()

@end

@implementation Bulk_Power_1_TVC
...
- (void)loadArrays {
    ...
    self.Titles = @[@"Overhead Press - Light",
                    ...
                    @"Clean & Squat - Light",
                    @"Clean & Squat - Heavy",
                    @"Clean Squat Press - Light",
                    @"Clean Squat Press - Heavy",
                    @"Clean Squat Jerk - L - Light",
                    @"Clean Squat Jerk - R - Light",
                    @"Clean Squat Jerk - Heavy",
                    @"1-Arm Clean Squat Jerk - L - Light",
                    @"1-Arm Clean Squat Jerk - L - Heavy",
                    @"1-Arm Clean Squat Jerk - R - Light",
                    @"1-Arm Clean Squat Jerk - R - Heavy"];
    ...
    self.exerciseLabelArray = @[self.exerciseLabel_1,
                                ...
                                self.exerciseLabel_26,
                                self.exerciseLabel_27,
                                self.exerciseLabel_28,
                                self.exerciseLabel_29,
                                self.exerciseLabel_30,
                                self.exerciseLabel_31];
    ...
    self.currentTextFieldArray = @[self.currentWeight_1,
                                   ...
                                   self.currentWeight_151,
                                   self.currentWeight_152,
                                   self.currentWeight_153,
                                   self.currentWeight_154,
                                   self.currentWeight_155,
                                   self.currentWeight_156,
                                   self.currentWeight_157,
                                   self.currentWeight_158,
                                   self.currentWeight_159,
                                   self.currentWeight_160,
                                   self.currentWeight_161,
                                   self.currentWeight_162,
                                   self.currentWeight_163,
                                   self.currentWeight_164,
                                   self.currentWeight_165,
                                   self.currentWeight_166,
                                   self.currentWeight_167,
                                   self.currentWeight_168,
                                   self.currentWeight_169,
                                   self.currentWeight_170,
                                   self.currentWeight_171,
                                   self.currentWeight_172,
                                   self.currentWeight_173,
                                   self.currentWeight_174,
                                   self.currentWeight_175,
                                   self.currentWeight_176,
                                   self.currentWeight_177,
                                   self.currentWeight_178,
                                   self.currentWeight_179,
                                   self.currentWeight_180,
                                   self.currentWeight_181,
                                   self.currentWeight_182,
                                   self.currentWeight_183,
                                   self.currentWeight_184,
                                   self.currentWeight_185,
                                   self.currentWeight_186];
    ...
    self.previousTextFieldArray = @[self.previousWeight_1,
                                    ...
                                    self.previousWeight_151,
                                    self.previousWeight_152,
                                    self.previousWeight_153,
                                    self.previousWeight_154,
                                    self.previousWeight_155,
                                    self.previousWeight_156,
                                    self.previousWeight_157,
                                    self.previousWeight_158,
                                    self.previousWeight_159,
                                    self.previousWeight_160,
                                    self.previousWeight_161,
                                    self.previousWeight_162,
                                    self.previousWeight_163,
                                    self.previousWeight_164,
                                    self.previousWeight_165,
                                    self.previousWeight_166,
                                    self.previousWeight_167,
                                    self.previousWeight_168,
                                    self.previousWeight_169,
                                    self.previousWeight_170,
                                    self.previousWeight_171,
                                    self.previousWeight_172,
                                    self.previousWeight_173,
                                    self.previousWeight_174,
                                    self.previousWeight_175,
                                    self.previousWeight_176,
                                    self.previousWeight_177,
                                    self.previousWeight_178,
                                    self.previousWeight_179,
                                    self.previousWeight_180,
                                    self.previousWeight_181,
                                    self.previousWeight_182,
                                    self.previousWeight_183,
                                    self.previousWeight_184,
                                    self.previousWeight_185,
                                    self.previousWeight_186];
    ...
    self.currentNotesArray = @[self.currentNotes_1,
                               ...
                               self.currentNotes_26,
                               self.currentNotes_27,
                               self.currentNotes_28,
                               self.currentNotes_29,
                               self.currentNotes_30,
                               self.currentNotes_31];
    ...
    self.previousNotesArray = @[self.previousNotes_1,
                                ...
                                self.previousNotes_26,
                                self.previousNotes_27,
                                self.previousNotes_28,
                                self.previousNotes_29,
                                self.previousNotes_30,
                                self.previousNotes_31];
