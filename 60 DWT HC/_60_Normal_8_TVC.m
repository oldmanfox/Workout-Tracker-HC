...
#import "_60_Normal_8_TVC.h"
#import "60DWTHCIAPHelper.h"
#import <iAd/iAd.h>

@interface _60_Normal_8_TVC ()

@end

@implementation _60_Normal_8_TVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    workoutArray = appDelegate._60_Normal_Week8_WorkoutNameArray;
    ...
    if ([selectedRoutine isEqualToString:@"60 - Normal"]) {
        ...
        if ([week isEqualToString:@"Week 8"]) {
            ...
            else if (selectedCell.tag == 15) {
                
                // Bulk Power 5
                ((DataNavController *)self.parentViewController).index = @5;
            }
            
            else if (selectedCell.tag == 16) {
