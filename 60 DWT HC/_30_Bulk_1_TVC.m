...
#import "_30_Bulk_1_TVC.h"
#import "60DWTHCIAPHelper.h"
#import <iAd/iAd.h>

@interface _30_Bulk_1_TVC ()

@end

@implementation _30_Bulk_1_TVC
...
- (void)LoadArray {
    ...
    self.tableDetailArray = @[self.cell6Detail,
                              self.cell7Detail,
                              self.cell8Detail,
                              self.cell9Detail];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    workoutArray = appDelegate._30_Bulk_Week1_WorkoutNameArray;
    ...
    // Normal routine
    if ([selectedRoutine isEqualToString:@"30 - Bulk"]) {
