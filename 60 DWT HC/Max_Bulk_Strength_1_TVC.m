...
#import "Max_Bulk_Strength_1_TVC.h"
...
@interface Max_Bulk_Strength_1_TVC ()

@end

@implementation Max_Bulk_Strength_1_TVC
...
- (void)loadArrays {
    ...
    self.Titles = @[@"Reverse Lunge - R",
                    @"Reverse Lunge - R - Heavy",
                    @"Reverse Lunge - L",
                    @"Reverse Lunge - L - Heavy",
                    @"Push-Up",
                    @"Bench Press - Heavy",
                    @"Squat",
